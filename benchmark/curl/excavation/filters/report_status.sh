#!/bin/sh
. ../../config.env
. ../../excavation_config.env

# --- Custom Variables ---
CORAL_BENCHMARK_ENDPOINT="/dashboard/resources?page=1&itemsPerPage=8&update=true&sortBy=resourceinstance__createdtime&sortOrder=desc&filterBy=Preliminary"
