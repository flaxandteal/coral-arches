...
# --- Custom Variables ---
CORAL_BENCHMARK_ENDPOINT="/dashboard/resources?page=1&itemsPerPage=8&update=true&sortBy=target_date_n1&sortOrder=desc&filterBy=LA03+-+Antrim+and+Newtownabbey+Borough+Council"
