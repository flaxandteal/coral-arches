...
# --- Custom Variables ---
CORAL_BENCHMARK_ENDPOINT="/dashboard/resources?page=1&itemsPerPage=8&update=true&sortBy=target_date_n1&sortOrder=desc&filterBy=1f358b66-4981-4d2e-bc87-a32919e3fb1c"
