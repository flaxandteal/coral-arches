...
class Command(BaseCommand):
    ...
    def reload_plugins_widgets(self, *args, **options):
        ...
        if has_plugin_change:
            ...
            update_plugin("edit-workflow")
            print("Updated: edit-workflow")

        if has_plugin_change or has_widget_change:
            print("Rebuilding webpack...")
            call_command(
                command="cd coral; DJANGO_MODE=DEV NODE_PATH=./media/node_modules NODE_OPTIONS=--max_old_space_size=8192 node --inspect ./media/node_modules/.bin/webpack --config webpack/webpack.config.dev.js"
            )
            print("Rebuild complete.")
        #     print("Rebuilding webpack...")
        #     call_command(
        #         command=f"cd coral; DJANGO_MODE=DEV NODE_PATH=./media/node_modules NODE_OPTIONS=--max_old_space_size=8192 node --inspect ./media/node_modules/.bin/webpack --config webpack/webpack.config.dev.js",
