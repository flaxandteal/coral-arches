define([
  ...
  return ko.components.register('active-consultations', {
    viewModel: function (params) {
      ...
      this.activeConsulationConfig = {
        // could pass this into GET req
        nodes: {
        ...
        ajax: {
          ...
          dataSrc: function (data) {
            ...
            consultations.forEach(function (consultation) {
              ...
              results.push([
                $('<a></a>').attr('href', link).text(consultation['Consultation Name'])[0]
                  .outerHTML,
                $('<a></a>').attr('href', link).text(consultation['Consultation Type'])[0]
                  .outerHTML,
                $('<a></a>').attr('href', link).text(consultation['Target Date Start'])[0]
                  .outerHTML,
