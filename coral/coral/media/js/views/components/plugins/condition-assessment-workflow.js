define([
  ...
  return ko.components.register('condition-assessment-workflow', {
    viewModel: function (params) {
      this.componentName = 'condition-assessment-workflow';
      this.stepConfig = [
        {
              ...
              componentConfigs: [
                {
                  ...
                  uniqueInstanceName: 'condition-assessment-workflow-info' /* unique to step */,
                  tilesManaged: 'one',
                  parameters: {
