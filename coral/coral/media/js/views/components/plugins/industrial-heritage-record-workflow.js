define([
  ...
  return ko.components.register('industrial-heritage-record-workflow', {
    viewModel: function (params) {
      this.componentName = 'industrial-heritage-record-workflow';
      this.stepConfig = [
        {
              ...
              componentConfigs: [
                {
                  ...
                  uniqueInstanceName: 'ihr-site-name',
                  tilesManaged: 'one',
                  parameters: {
          ...
          layoutSections: [
            {
              componentConfigs: [
                ...
                {
                  componentName: 'default-card',
                  uniqueInstanceName: 'ihr-valuation',
                  tilesManaged: 'one',
                  parameters: {
                    graphid: '076f9381-7b00-11e9-8d6b-80000b44d1d9',
