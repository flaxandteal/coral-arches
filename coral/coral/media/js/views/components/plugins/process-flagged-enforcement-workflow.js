define([
  ...
  'templates/views/components/plugins/process-flagged-enforcement-workflow.htm',
  ...
  return ko.components.register('process-flagged-enforcement-workflow', {
    viewModel: function (params) {
      this.componentName = 'process-flagged-enforcement-workflow';
