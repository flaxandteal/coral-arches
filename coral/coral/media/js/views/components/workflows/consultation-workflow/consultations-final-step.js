define([
  ...
  'templates/views/components/workflows/consultation-workflow/consultations-final-step.htm'
  ...
  function viewModel(params) {
    ...
    this.resourceData.subscribe(function (val) {
      ...
      this.reportVals = {
        ...
        logDate: {
          name: 'Log Date',
          value: this.getResourceValue(val.resource, ['Consultation Dates', 'Log Date', '@value'])
        },
        targetDate: {
          name: 'Target Date',
          value: this.getResourceValue(val.resource, [
        ...
        consultationType: {
          ...
          value: this.getResourceValue(val.resource, ['Consultation Type', '@value'])
        },
        applicationType: {
          name: 'Application Type',
          value: this.getResourceValue(val.resource, ['Application Type', '@value'])
        },
        developmentType: {
          name: 'Development Type',
          value: this.getResourceValue(val.resource, ['Development Type', '@value'])
        },
        proposalDescription: {
          name: 'Proposal Description',
          value: this.getResourceValue(val.resource, ['Proposal', [0], 'Proposal Text', '@value'])
        },
        planningOfficer: {
        ...
        consultingContact: {
          ...
          value: this.getResourceValue(val.resource, ['Contacts', 'Consulting Contact', '@value'])
        },
        caseworkOfficer: {
        ...
        agent: {
          name: 'Agent',
          value: this.getResourceValue(val.resource, ['Contacts', 'Agents', 'Agent', '@value'])
        },
        owner: {
          name: 'Owner',
        ...
        relatedApplicationAreas: {
          name: 'Related Application Areas',
          value: this.getResourceValue(val.resource, [
            'Consultation Area',
            'Geometry',
        ...
        locationDescription: {
          name: 'Consultation Location Description',
          value: this.getResourceValue(val.resource, [
            'Consultation Area',
            'Geometry',
            'Consultation Location Descriptions',
            'Consultation Location Description',
            '@value'
          ])
        }
      };
      ...
      try {
        this.reportVals.references = val.resource['References'].map(function (ref) {
          return {
            referenceNumber: {
              name: 'Reference',
              value: self.getResourceValue(ref, ['Agency Identifier', 'Reference', '@value'])
            },
            referenceType: {
              name: 'Reference Type',
              value: self.getResourceValue(ref, ['Agency Identifier', 'Reference Type', '@value'])
            },
      ...
      var geojsonStr = this.getResourceValue(val.resource, [
        'Consultation Area',
        'Geometry',
      ...
      if (!val.resource['Status']) {
        ...
        window
          .fetch(arches.urls.api_tiles(uuid.generate()), {
            method: 'POST',
            credentials: 'include',
    ...
    this.relatedResources.subscribe(function (val) {
      ...
      if (digitalResource) {
        self.relatedFile = {
          name: 'Related Files',
          value: digitalResource.displayname,
          link: `${arches.urls.resource}\\${digitalResource.resourceinstanceid}`
        };
      } else {
