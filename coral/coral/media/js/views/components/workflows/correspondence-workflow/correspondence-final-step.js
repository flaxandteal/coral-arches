define([
  ...
  'viewmodels/alert',
  'templates/views/components/workflows/correspondence-workflow/correspondence-final-step.htm'
], function (
  $,
  arches,
  ko,
  ...
  SummaryStep,
  AlertViewModel,
  correspondenceFinalStepTemplate
) {
  function viewModel(params) {
    ...
    this.resourceData.subscribe(function (val) {
      ...
      this.reportVals = {
        ...
        letterType: {
          name: 'Letter Type',
          value: this.getResourceValue(currentCorrespondence, ['Letter Type', '@value'])
        },
