define([
  ...
  'viewmodels/alert',
  'templates/views/components/workflows/correspondence-workflow/correspondence-select-resource.htm'
], function (
  _,
  $,
  uuid,
  ...
  SelectResourceStep,
  AlertViewModel,
  correspondenceSelectResourceStepTemplate
) {
      ...
      $.ajax({
        ...
        .fail(function (response) {
          if (response.statusText !== 'abort') {
            ...
            params.pageVm.alert(
              new AlertViewModel('ep-alert-red', arches.requestFailed.title, response.responseText)
            );
          }
        });
    };
