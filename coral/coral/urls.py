...
from coral.views.workflow_builder import WorkflowBuilder, WorkflowBuilderGraphComponents, WorkflowBuilderCardOverride, WorkflowBuilderWorkflowRegister
...
urlpatterns = [
    ...
    url(r"^workflow-builder/register", WorkflowBuilderWorkflowRegister.as_view(), name="wb_register")
