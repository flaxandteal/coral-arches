class NotificationManager():
    def __init__(self, node_group_id, user, tile, strategy_registry, request):
        ...
        self.strategy = self._select_strategy(node_group_id, request)
        # self.strategy.delete_existing_notification(tile)

    def _select_strategy(self, node_group_id, request):
