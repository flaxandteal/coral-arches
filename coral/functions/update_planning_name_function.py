...
PLANNING_REFERENCE_NODEGROUP_ID = "f7aa45ad-8811-5bcf-b9cf-ac24b4a593ec"
PLANNING_REFERENCE_NODE_ID = "8be0fb93-164a-5d51-904f-61a81b8f8b77"
...
DISPLAY_NAME_NODEGROUP_ID = "4b76a69e-b6ab-5ddb-8748-5f61dafbb91d"
DISPLAY_NAME_NODE_ID = "6c8ca254-83a2-5f0d-a9f3-ab1515d17340"
...
class UpdatePlanningNameFunction(BaseFunction):
    ...
    def post_save(self, tile, request, context):
        ...
        if system_reference_tile:
            ...
            if resource_id_value and resource_id_value.startswith('extrados'):
