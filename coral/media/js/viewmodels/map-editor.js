...
import mapEditorTemplate from 'templates/views/components/map-editor.htm';
...
var viewModel = function(params) {
    ...
    var setupDraw = async function(map) {
        const { default: MapboxDraw } = await import('mapbox-gl-draw');
        {
