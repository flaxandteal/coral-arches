...
import template from 'templates/views/viewmodels/workflow-builder-config.htm';
import colorPicker from 'bindings/color-picker';
import iconSelector from 'views/components/icon-selector';
import generateSlug from 'viewmodels/generate-slug';
...
export default WorkflowBuilderConfig;
