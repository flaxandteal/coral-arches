...
import djangoGroupAccountCardTemplate from 'templates/views/components/cards/django-group-card.htm';
...
export default ko.components.register('django-group-card', {
        viewModel: viewmodel,
        template: djangoGroupAccountCardTemplate
    });
