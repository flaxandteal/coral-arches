...
import pageTemplate from 'templates/views/components/plugins/dashboard.htm';
import dashboardCard from 'views/components/cards/dashboard-card';
...
export default ko.components.register('dashboard', {
