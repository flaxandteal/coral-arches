...
import groupManagerTemplate from 'templates/views/components/plugins/group-manager.htm';
import groupManagerGraph from 'views/components/plugins/group-manager-graph';
import datepicker from 'bindings/datepicker';
...
export default ko.components.register('group-manager', {
        viewModel: viewModel,
