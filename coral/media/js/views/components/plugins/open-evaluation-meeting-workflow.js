...
import pageTemplate from 'templates/views/components/plugins/open-evaluation-meeting-workflow.htm';
...
export default ko.components.register('open-evaluation-meeting-workflow', {
