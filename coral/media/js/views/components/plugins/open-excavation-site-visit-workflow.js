...
import pageTemplate from 'templates/views/components/plugins/open-excavation-site-visit-workflow.htm';
...
export default ko.components.register('open-excavation-site-visit-workflow', {
