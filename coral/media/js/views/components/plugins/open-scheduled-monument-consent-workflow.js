...
import pageTemplate from 'templates/views/components/plugins/open-scheduled-monument-consent-workflow.htm';
...
export default ko.components.register('open-scheduled-monument-consent-workflow', {
