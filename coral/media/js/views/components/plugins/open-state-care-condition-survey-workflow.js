...
import pageTemplate from 'templates/views/components/plugins/open-state-care-condition-survey-workflow.htm';

const openWorkflowViewModel = function (params) {
  OpenWorkflow.apply(this, [params]);
  this.OPEN_WORKFLOW_CONFIG = 'open-workflow-config';

  this.searchString = "/search/resources?advanced-search=[{\"op\"%3A\"and\"%2C\"d146451b-9140-5f81-b3de-9005acc01e28\"%3A{\"op\"%3A\"not_null\"%2C\"lang\"%3A\"en\"%2C\"val\"%3A\"\"}%2C\"0b14fb28-961e-5817-9cac-c61073b58981\"%3A{\"op\"%3A\"~\"%2C\"lang\"%3A\"en\"%2C\"val\"%3A\"\"}%2C\"4b9883ef-9aad-559a-bd84-e4bb7b94a358\"%3A{\"op\"%3A\"~\"%2C\"lang\"%3A\"en\"%2C\"val\"%3A\"\"}%2C\"1edc61a9-b64b-51ae-9077-536908761903\"%3A{\"op\"%3A\"~\"%2C\"lang\"%3A\"en\"%2C\"val\"%3A\"\"}}]"
...
export default ko.components.register('open-state-care-condition-survey-workflow', {
