...
import pageTemplate from 'templates/views/components/plugins/view-enforcements.htm';
import pagingFilter from 'views/components/search/paging-filter';
...
export default ko.components.register('view-enforcements', {
