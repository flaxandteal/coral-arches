...
import pageTemplate from 'templates/views/components/plugins/workflow-builder-editor.htm';
import WorkflowBuilderStep from 'viewmodels/workflow-builder-step';
import WorkflowBuilderConfig from 'viewmodels/workflow-builder-config';
...
export default ko.components.register('workflow-builder-editor', {
