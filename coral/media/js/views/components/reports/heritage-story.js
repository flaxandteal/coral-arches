...
import heritageStoryReportTemplate from 'templates/views/components/reports/heritage-story.htm';
import name from 'views/components/reports/scenes/name';
import json from 'views/components/reports/scenes/json';

export default ko.components.register('heritage-story-report', {
