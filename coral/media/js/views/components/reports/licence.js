...
import historicLandscapeCharacterizationReportTemplate from 'templates/views/components/reports/licence.htm';
import name from 'views/components/reports/scenes/name';
import json from 'views/components/reports/scenes/json';

export default ko.components.register('licence-report', {
