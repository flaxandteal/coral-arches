...
import djangoGroupReportTemplate from 'templates/views/components/reports/scenes/django-group.htm';
import datatable from 'bindings/datatable';
import keyvalue from 'views/components/reports/scenes/keyvalue';

export default ko.components.register('views/components/reports/scenes/django-group', {
