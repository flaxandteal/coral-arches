...
import imagesReportTemplate from 'templates/views/components/reports/scenes/images.htm';
import datatable from 'bindings/datatable';

export default ko.components.register('views/components/reports/scenes/images', {
