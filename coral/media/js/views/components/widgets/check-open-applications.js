...
import checkOpenApplicationsTemplate from 'templates/views/components/widgets/check-open-applications.htm';
 ...
 */
export default ko.components.register('check-open-applications', {
  viewModel,
