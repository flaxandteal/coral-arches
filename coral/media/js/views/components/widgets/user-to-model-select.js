...
import template from 'templates/views/components/widgets/user-to-model-select.htm';
import userToModelConfig from './user-to-model-config.json';
...
export default ko.components.register('user-to-model-select', {
    viewModel,
    template: template
  });
