define([
  ...
  function viewModel(params) {
    ...
    this.totalCompositeScore = ko.observable(this.tile.data[this.CONDITION_SCORE_NODE_ID]() && this.tile.data[this.RISK_SCORE_NODE_ID]() ? this.scoreLookup[this.tile.data[this.CONDITION_SCORE_NODE_ID]()] * this.scoreLookup[this.tile.data[this.RISK_SCORE_NODE_ID]()] : 0);
