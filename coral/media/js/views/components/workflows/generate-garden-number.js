...
import template from 'templates/views/components/workflows/generate-garden-number.htm';
...
function viewModel(params) {
  ...
  this.GENERATED_GARDEN_NODE_ID = '91fc174d-d278-5be0-b8ff-f547877b1e4e';
