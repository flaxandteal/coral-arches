describe('Going through the Flag For Enforcement Workflow', function () {
    ...
    it('Go through the workflow and populate all fields', function () {
        ...
        cy.get('[aria-label="Flagged Date"]').siblings('.bootstrap-datetimepicker-widget').contains(day.toString()).click();
        ...
        cy.contains('Flagged Date Value:').siblings().should('contain', day.toString());
        cy.contains('Actor:').siblings().should('have.text', 'John Doe');
    ...
    it('Workflow with only Associated Resource', function () {
        ...
        cy.contains('Select resources').siblings('.row').click();
        cy.wait(1500);
        cy.contains('HA/01 Testing').click();
        cy.wait(1500);
