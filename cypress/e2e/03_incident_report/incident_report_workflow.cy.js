describe('Going through the Incident Report', function () {
    ...
    it('Record of Incident select and unselect', function () {
        ...
        cy.wait(2000);
        cy.get('.select2-results__option').first().click();
        cy.get('.select2-selection__clear').first().click()
     ...
     it('Location tab specific tests', function () {
        cy.contains('Workflows');
        cy.contains('Incident Report').click();
        cy.wait(2000);
        cy.get('.card-component').contains('Please select a Monument').click();
    ...
    it('Work proposed specific tab', function(){
        cy.contains('Workflows');
        cy.contains('Incident Report').click();
        cy.wait(2000);
        cy.get('.card-component').contains('Please select a Monument').click();
    ...
    it('Sign Off tab, select unselect, clear', function(){
        cy.contains('Workflows');
        cy.contains('Incident Report').click();
        cy.wait(2000);
        cy.get('.card-component').contains('Please select a Monument').click();
